function NewFiles = import_data_MOTOR_LAB(DataFiles, ChannelMat, FileFormat, iStudyInit, iSubjectInit, ImportOptions, DateOfStudy)
...
for iFile = 1:length(DataFiles)  
    ...
    if ~isempty(sFile)
        ...
        % CHANGED TO ACCOMODATE PARALLEL LOADING
