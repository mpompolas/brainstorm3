function varargout = process_import_data_event_MOTOR_LAB( varargin )
...
% Changed to accomodate parallel importing: Konstantinos Nasiotis, 2020
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Comment     = 'Import MEG/EEG: Events - Parallel';
    sProcess.Category    = 'File';
    sProcess.SubGroup    = {'Dancause Lab', 'Import recordings'};
    sProcess.Index       = 1822;
...
function OutputFiles = Run(sProcess, sInput) %#ok<DEFNU>
    ...
    for iFile = 1:length(FileNames)
        ...
        % Changed to accomodate Parallel importing
        % Import file
        NewFiles = import_data_MOTOR_LAB(sFile, ChannelMat, FileFormat, iStudy, iSubject, ImportOptions);
